...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Use the PDO instance from your configuration file
    global $conn;
    ...
    if ($user) {
        ...
        $UserObj->delete_existing_tokens($email);
        $UserObj->reset_token($email, $token);
        ...
        <tbody>
            ...
            '
                                                                                                                                ...
                                                                                                                                <p
                                                                                                                                    style="margin: 0; font-size: 18px; line-height: 1.8; word-break: break-word; text-align: center; mso-line-height-alt: 32px; margin-top: 0; margin-bottom: 0;">
                                                                                                                                    <a href="http://localhost/legalkarnataka/client/reset-password.php?token=' . $token . '"
        ...
        try {
            ...
            $mail->send();
            header('Location: forgot-password.php?success=' . urlencode('You will receive a reset link if the user is present in the database.'));
            exit;
        } catch (Exception $e) {
        ...
        // User does not exist
        header('Location: forgot-password.php?message=' . urlencode('You will receive a reset link if the user is present in the database.'));
        exit;
    }
}
?>
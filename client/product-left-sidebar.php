                                ...
                                <li>
                                    <?php foreach ($categories as $category): ?>
                                        ...
                                        foreach ($subCategories as $subCategory) {
                                            ...
                                            echo '<li>';
                                            echo '<div class="ec-sidebar-sub-item"><a href="#">' . $subCategory . '</a></div>';
                                            echo '</li>';
                                            echo '</ul>';
                                        }
                                        ?>
                    ...
                    <div class="ec-sb-pro-sl">
                        ...
                        <div>
                            <div class="ec-sb-pro-sl-item">
                                ...
                                <div class="ec-pro-content">
                                    <h5 class="ec-pro-title"><a href="product-left-sidebar.html">Black Leather Belt</a>
                                    </h5>
                                    <div class="ec-pro-rating">
                                        <i class="ecicon eci-star fill"></i>
                                        <i class="ecicon eci-star fill"></i>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6 pro-gl-content">
                <div class="ec-product-inner">
                    <div class="ec-pro-image-outer">
                        <div class="ec-pro-image">
                            <a href="product-left-sidebar.html" class="image">
                                <img class="main-image" src="assets/images/product-image/independent_agreement.jpg"
                                    alt="Product" />
                                <img class="hover-image" src="assets/images/product-image/independent_agreement.jpg"
                                    alt="Product" />
                            </a>
                            <span class="percentage">20%</span>
                            <span class="flags">
                    ...
                    <div class="col-sm-12 col-lg-3 ec-footer-contact">
                        <div class="ec-footer-widget">
                            <div class="ec-footer-logo"><a href="#"><img src="assets/images/logo/legalkarnataka.jpeg"
                                        ...
                                        src="assets/images/logo/legalkarnataka.jpeg" alt="Site Logo"

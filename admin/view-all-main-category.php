        ...
        <div class="breadcrumb-wrapper breadcrumb-contacts">
            <div>
                ...
                <p class="breadcrumbs"><span><a href="index.html">Home</a></span>
                    <span><i class="mdi mdi-chevron-right"></i></span>Main Category List
                </p>
            </div>
            <div>
                        ...
                        <div class="table-responsive">
                            <table id="responsive-data-table" class="table">
                                ...
                                <tbody>
                                    ...
                                    $categoryObj = new MainCategory($conn);
                                    $mainCategory = $categoryObj->getMainCategories();
                                    foreach ($mainCategory as $categories) {
                                        echo '<tr>';
                                        ...
                                        echo '<a class="dropdown-item" href="main-edit.php?id=' . $categories["id"] . '">Edit</a>';
...
<script>
    function confirmDelete(Id) {
        Swal.fire({
            ...
            if (result.value) {
                window.location.replace("delete_main.php?id=" + Id);
            }
        });
    }
</script>
